...
dim(data1)
# Déterminer la taille de l'échantillon désirée pour chaque classe
sample_size <- 1000

# Appliquer le sous-échantillonnage et le sur-échantillonnage
ros_object <- ovun.sample(Bankrupt. ~ ., data = data1, method = "both", N = sample_size, seed = 42)

# Extraire les données équilibrées du résultat
